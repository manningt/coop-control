...
parser.add_argument('-a', dest='activation_time', type=int, default=15, help='seconds to leave relay on')
...
if __name__ == '__main__':
    ...
    print("success: GPIO pin {} activated for {} seconds".format(args.relay_pin, args.activation_time))
    sys.exit(0)
